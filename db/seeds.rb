...
Camper.create(username:"thirdcamper", password_digest:"cat", is_admin:true)
Camper.create(username:"fourthcamper", password_digest:"cat", is_admin:true)
Camper.create(username:"fifthcamper", password_digest:"cat", is_admin:true)

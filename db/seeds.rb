...
Camper.create(username:"secondcamper", password:"cat", is_admin:false)
...
Camper.create(username:"laura", password:"cat", is_admin:true)
...
3.times{
    sd = (Faker::Date.between(from: '2023-05-01', to: '2023-09-30'))
    ed = sd + rand(1..7)
    laura = Camper.find_by(username: "laura")
    Reservation.create(camper_id: laura.id, campsite_id:campsites.sample, start_date:sd, end_date:ed)
}
